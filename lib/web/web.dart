...
class _WebScreenState extends State<WebScreen> {
  ...
  void nextQuestion() {
   ...
   setState(() => currentQuestion++);
    ...
    if (currentQuestion <= totalQuestions!) {
      ...
      firestore.collection("controle").doc('K7EOVAZ1NIDtjeenbvV7').update({'pergunta_corrente': 1});
           //;
      ...
      Navigator.push(
         context,
        MaterialPageRoute(
          builder: (context) => const TelaDeAcertos(),
        ),
       );
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tempo restante: $timerDuration segundos', style: const TextStyle(color: Colors.white),
