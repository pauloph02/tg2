...
import 'perguntacinco.dart';


class PerguntaQuatro extends StatefulWidget {
  int acertos;
   PerguntaQuatro({Key? key, required this.acertos}) : super(key: key);
  

  @override
  State<PerguntaQuatro> createState() => _PerguntaQuatroState();
}

class _PerguntaQuatroState extends State<PerguntaQuatro> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: StreamBuilder<QuerySnapshot>(
        stream: firestore.collection("questions").where('id', isEqualTo: "d").snapshots(),
          ...
          var pergunta = questions.map((q) => q['question']);
           ...
           corrigir(resposta){
            if (resposta == respostaCerta){
              ...
              Navigator.push(context, MaterialPageRoute(builder: (context) => PerguntaCinco(acertos: widget.acertos,) ));
           }
