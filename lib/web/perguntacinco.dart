...
class PerguntaCinco extends StatefulWidget {
  int acertos;
   PerguntaCinco({Key? key, required this.acertos}) : super(key: key);
  

  @override
  State<PerguntaCinco> createState() => _PerguntaCincoState();
}

class _PerguntaCincoState extends State<PerguntaCinco> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: StreamBuilder<QuerySnapshot>(
        stream: firestore.collection("questions").where('id', isEqualTo: "e").snapshots(),
          ...
          var pergunta = questions.map((q) => q['question']);
           ...
           corrigir(resposta){
            if (resposta == respostaCerta){
              ...
              Navigator.push(context, MaterialPageRoute(builder: (context) => TelaDeAcertos(acertos: widget.acertos,) ));
