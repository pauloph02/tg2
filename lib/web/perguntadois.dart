...
import 'package:tg/web/perguntatres.dart';


class PerguntaDois extends StatefulWidget {
  int acertos;
   PerguntaDois({Key? key, required this.acertos}) : super(key: key);
  

  @override
  State<PerguntaDois> createState() => _PerguntaDoisState();
}

class _PerguntaDoisState extends State<PerguntaDois> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: StreamBuilder<QuerySnapshot>(
        stream: firestore.collection("questions").where('id', isEqualTo: "b").snapshots(),
          ...
          var pergunta = questions.map((q) => q['question']);
           ...
           corrigir(resposta){
            ...
            print(widget.acertos);
              Navigator.push(context, MaterialPageRoute(builder: (context) => PerguntaTres(acertos: widget.acertos,) ));
           }
